...
import cl.javadevs.springsecurity.dtos.DtoAuthRespuesta;
import cl.javadevs.springsecurity.dtos.DtoLogin;
import cl.javadevs.springsecurity.dtos.DtoRegistro;
import cl.javadevs.springsecurity.models.Roles;
import cl.javadevs.springsecurity.models.Usuario;
import cl.javadevs.springsecurity.repositories.IRolesRepository;
import cl.javadevs.springsecurity.repositories.IUsuariosRepository;
import cl.javadevs.springsecurity.security.JwtGenerador;
...
public class RestControllerAuth {
    ...
    public ResponseEntity<String> registrar(@RequestBody DtoRegistro dtoRegistro) {
        ...
        usuarios.setPass(passwordEncoder.encode(dtoRegistro.getPass()));
    ...
    public ResponseEntity<DtoAuthRespuesta> login(@RequestBody DtoLogin dtoLogin) {
        Authentication authentication = authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(
                dtoLogin.getUsername(), dtoLogin.getPass()));
